...
export default function ConciergeButton() {
  ...
  return (
    <button
      ...
      className="group fixed bottom-6 right-6 z-30 flex items-center gap-2 rounded-full bg-violet-600 px-4 py-3 text-sm font-medium text-white shadow-lg transition-all hover:bg-violet-700 hover:shadow-xl"
